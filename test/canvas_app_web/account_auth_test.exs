defmodule CanvasAppWeb.AccountAuthTest do
  use CanvasAppWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias CanvasApp.Accounts
  alias CanvasAppWeb.AccountAuth
  import CanvasApp.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CanvasAppWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      CanvasAppWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "on_mount: ensure_authenticated" do
    ...
    test "redirects to login page if there isn't a valid account_token", %{conn: conn} do
      ...
      socket = %LiveView.Socket{
        endpoint: CanvasAppWeb.Endpoint,
