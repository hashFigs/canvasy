defmodule CanvasAppWeb.AccountAuth do
  use CanvasAppWeb, :verified_routes

  import Plug.Conn
  import Phoenix.Controller

  alias CanvasApp.Accounts

  # Make the remember me cookie valid for 60 days.
  # If you want bump or reduce this value, also change
  # the token expiry itself in AccountToken.
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_canvas_app_web_account_remember_me"
  ...
  def log_out_account(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      CanvasAppWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_account:
      ...
      defmodule CanvasAppWeb.PageLive do
        use CanvasAppWeb, :live_view

        on_mount {CanvasAppWeb.AccountAuth, :mount_current_account}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{CanvasAppWeb.AccountAuth, :ensure_authenticated}] do
